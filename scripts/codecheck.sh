...
#pylint argument :
disabled="C0324,C0103,C0301,C0111,R0914,R0903,R0915,R0904,R0912,R0201,R0913,C0323,R0902,W0102,W0232,W0105,C0321,W0401,W0142"
args="--rcfile=/dev/null --include-ids=y --reports=n"
grepped_out="Locally disabling"
grep_out2="Undefined variable \'\_\'"
...
echo "Running pylint"
echo "#################"
pylint --rcfile=/dev/null --include-ids=y --reports=n --disable-msg=$disabled GTG/gtg.py|grep -v "$grepped_out"|grep -v "$grep_out2"
for i in GTG/*; do
