...
setup(
  ...
  package_data = {
    ...
    'GTG.plugins.hamster': ['prefs.ui',
                            'icons/hicolor/32x32/hamster-activity-start2.png',
                            'icons/hicolor/32x32/hamster-activity-stop2.png',
                            'icons/hicolor/svg/hamster-activity-start2.svg',
                            'icons/hicolor/svg/hamster-activity-stop2.svg'],
