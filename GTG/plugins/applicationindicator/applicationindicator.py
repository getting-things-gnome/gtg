...
class ApplicationIndicator:
    ...
    PLUGIN_NAME = "applicationindicator"
    MAX_TITLE_LEN = 30
    ...
    def activate(self, plugin_api):
        ...
        print data_dir + "/icons/hicolor/16x16/apps/gtg.png"
        ...
        self.on_icon_popup(None, None, None, self.menu)
...
#        self.statusicon.connect('popup-menu', self.on_icon_popup, self.menu)
    ...
    def populate_menu(self):
        ...
        if len(task_list) > 0 and self.task_separator == None:
            print "task list greater than zero"
