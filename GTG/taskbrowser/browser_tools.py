...
def init_closed_tasks_tview(tv, tv_sort_cb):
    ...
    tag_col.set_title             (_("Tags"))
    tag_col.pack_start            (render_tags, expand=False)
    tag_col.add_attribute         (render_tags, "tag_list", CTASKS_MODEL_TAGS)
    render_tags.set_property      ('xalign', 0.0)
    tag_col.set_resizable         (False)
    tag_col.add_attribute         (render_tags, "cell-background", CTASKS_MODEL_BGCOL)
    #tag_col.set_clickable         (True)
    ...
    ddate_col.set_attributes           (render_text  , markup=CTASKS_MODEL_DDATE_STR)
    ddate_col.set_sort_column_id       (CTASKS_MODEL_DDATE)
    ddate_col.add_attribute            (render_text, "cell_background", CTASKS_MODEL_BGCOL)
    tv.append_column  (ddate_col)
    ...
    title_col.set_expand               (True)
    title_col.add_attribute            (render_text, "cell_background", CTASKS_MODEL_BGCOL)
    tv.append_column  (title_col)
